...
const StatCard = ({
  ...
  return (
    <div className="md:row-span-1 xl:row-span-2 col-span-1 flex flex-col justify-between bg-white shadow-md rounded-2xl">
      {/* HEADER */}
      <div>
      ...
      <div className="flex mb-6 items-center justify-around gap-4 px-5">
        <div className="rounded-full p-5 bg-blue-50 border-sky-300 boder-[1px]">
          {primaryIcon}
        </div>
              ...
              <div className="flex items-center justify-between my-4">
                ...
                <div className="flex items-center">
                  <detail.IconComponent
                    className={`w-4 h-4m mr-1 ${getChangeColor(
